...
import abCurso.ABCCursos_Service;
...
public class createCourse extends javax.swing.JFrame {
    ...
    //ABCCusos abc;
    abCurso.ABCCursos abc;
    ABCCursos_Service abc_S = new ABCCursos_Service();
    public createCourse() {
        initComponents();
        abc = abc_S.getABCCursosPort();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Cant. de Creditos:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            if(this.jTextField1.getText().trim().equals("") || this.jTextField2.getText().trim().equals("")){
                JOptionPane.showMessageDialog(null, "Favor llenar todos los campos..", "Crear Curso", JOptionPane.ERROR_MESSAGE);
                return;
            }
            String res = abc.agregar(this.jTextField1.getText(), Integer.parseInt(this.jTextField2.getText()));
            if(new messagesError().MessageError(res, "Crear Curso")){
                this.jTextField1.setText("");
                this.jTextField2.setText("");
            }
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, "Ocurrio un error..", "Crear Curso", JOptionPane.ERROR_MESSAGE);
        }
