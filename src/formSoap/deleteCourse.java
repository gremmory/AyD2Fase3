    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            if(this.jTextField1.getText().trim().equals("")){
                JOptionPane.showMessageDialog(null, "Favor llenar todos los campos..", "Eliminar Curso", JOptionPane.ERROR_MESSAGE);
                return;
            }
            String res = abc.eliminar(Integer.parseInt(this.jTextField1.getText()));
            if(new messagesError().MessageError(res, "Eliminar Curso")){
